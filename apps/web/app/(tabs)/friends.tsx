...
const styles = StyleSheet.create({
  ...
  importBtn: { marginTop: 8, borderWidth: 1, borderColor: '#4F46E5', borderRadius: 10, padding: 12, alignItems: 'center' },
  importBtnText: { color: '#4F46E5', fontWeight: '600', fontSize: 14 },
  createEventBtn: { backgroundColor: '#4F46E5', borderRadius: 10, padding: 14, alignItems: 'center' },
